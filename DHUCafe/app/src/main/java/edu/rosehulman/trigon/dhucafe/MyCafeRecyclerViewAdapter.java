...
/**
 * {@link RecyclerView.Adapter} that can display a {@link CafeItem} and makes a call to the
 * specified {@link CafeListFragment.OnListFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class MyCafeRecyclerViewAdapter extends RecyclerView.Adapter<MyCafeRecyclerViewAdapter.ViewHolder> {

    private final List<CafeItem> mValues;
    private final CafeListFragment.OnListFragmentInteractionListener mListener;

    public MyCafeRecyclerViewAdapter(List<CafeItem> items, CafeListFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
